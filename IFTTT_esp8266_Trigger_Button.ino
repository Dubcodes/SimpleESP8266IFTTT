//original sauce: https://randomnerdtutorials.com/esp8266-wi-fi-button-diy-amazon-dash-button-clone/
...
const char* resource = "/trigger/mail/with/key/o_VL9blahblalhvlah&somethingelsehere,thanks";
